...
const About = () => {
    ...
    return (
      <div className="container">
        ...
        <p className="recipeDescp">In this project react frontend application is fetching recipe detials using restAPI exposed by the backend application, backend is implemented using PHP Symfony framework and deployed on Heroku. 
        </p>
      </div>
    );
  }
